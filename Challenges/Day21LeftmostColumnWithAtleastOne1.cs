...
{
  public class Day21LeftmostColumnWithAtleastOne1
  {
    /*
    ...
    */
    ...
    public int LeftMostColumnWithOne(BinaryMatrix binaryMatrix)
    {
      ...
      var noOfRows = dimensions[0];
      var noOfColumns = dimensions[1];

      var i = 0;
      var j = noOfColumns - 1;
      var leastColIndex = -1;

      while (i < noOfRows && j >= 0)
      {
        if (binaryMatrix.Get(i, j) == 0)
        {
          ...
          if (i == noOfRows)
          {
            return leastColIndex;
          }
        }
        else
        {
          if (leastColIndex == -1 || j < leastColIndex)
          {
            leastColIndex = j;
          }
          j--;
